...
package org.firstinspires.ftc.teamcode.utils.wpilib;
...
public class Debouncer {
     ...
     */
    public Debouncer(double debounceTime, DebounceType type, Bot bot) {
        this.bot = bot;
     ...
     *     value to change.
     */
    public Debouncer(double debounceTime, Bot bot) {
        this(debounceTime, DebounceType.kRising, bot);
    }

    private void resetTimer() {
        m_prevTimeSeconds = bot.getTimestamp();
    }

    private boolean hasElapsed() {
        return bot.getTimestamp() - m_prevTimeSeconds >= m_debounceTimeSeconds;
    }
